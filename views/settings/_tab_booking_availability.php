...
<h2 class="sln-box-title sln-box__paneltitle"><?php esc_html_e('Availability mode', 'salon-booking-system');?> <span><?php esc_html_e('Select your favourite booking system mode.', 'salon-booking-system')?></span></h2>
...
?>
    ...
    <div class="col-xs-12 col-sm-4 form-group sln-box-maininfo">
        <p class="sln-box-info"><?php esc_html_e('Choose which kind of booking algorithm want to use for your salon according to your specific booking needs.', 'salon-booking-system');?></p>
    </div>
</div>
</div>
</div>
