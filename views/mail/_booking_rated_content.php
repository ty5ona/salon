...
<tr>
	...
	<?php
	    ...
	    esc_html_e('your customers','salon-booking-system');

	    $usermeta = get_user_meta($booking->getUserId());

	    echo ' ' . esc_attr($usermeta['first_name'][0]) . ' ' . esc_attr($usermeta['last_name'][0]) . ' ';

	    esc_html_e('has submitted a new review on his last visit at','salon-booking-system');
...
<tr>
	...
	<?php
	    ...
	    echo (isset($comments[0]) ? '“' .esc_attr($comments[0]->comment_content) . '”' : '');
	?>
	...
	<a href="<?php echo esc_url(add_query_arg(array('p' => $booking->getId()), admin_url('edit-comments.php'))); ?>#salon-review" style="
	    ...
	    margin-left: 20px">
		<?php esc_html_e('READ THE FULL REVIEW','salon-booking-system'); ?>
	</a>
    </td>
</tr>
<tr>
